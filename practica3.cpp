...
void CrearPiramideTriangular()
{
	...
	GLfloat vertices_piramide_triangular[] = {
		-0.5f,  -0.2887f,  0.0f,	// 0: Vértice Frente Izquierda
		 0.5f,  -0.2887f,  0.0f,	// 1: Vértice Frente Derecha
		 0.0f,   0.5774f,  0.0f,	// 2: Punta superior (Ápice)
		 0.0f,   0.0f,    -0.8165f
...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.75f, -2.5f));y
